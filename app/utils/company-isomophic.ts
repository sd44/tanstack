...
function generateRandomTask(): CompSeed {
  return {
    ...
    registeredCapital: faker.number.int({ min: 0 }),
...
export async function SeedComp() {
  const x = Array.from({ length: 100 }, () => generateRandomTask());
  // const msg = await insert(enterprises, x);
  // console.log(msg);
}

...
import { visitReadMyDatas } from '~/lib/db/CRUD/visit-datas';
import type { visitSelectT } from '~/lib/db/schema';
import { DataTable } from '../data-table';
import { tstColumnDefs } from './columns';
import { columnsConfig } from './filters';

export const getVisits = queryOptions({
  queryKey: ['getVisitDatas'],
  queryFn: visitReadMyDatas,
  placeholderData: [],
});
...
function VisitsTable({
  ...
  const { data } = useSuspenseQuery(getVisits);

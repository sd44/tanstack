...
import { entryReadMydatas } from '~/lib/db/CRUD/entry-datas';
import type { enterprisesSelectT } from '~/lib/db/schema';
import { DataTable } from '../data-table';
import { tstColumnDefs } from './columns';
import { columnsConfig } from './filters';

export const getComps = queryOptions({
  queryKey: ['getCompDatas'],
  queryFn: entryReadMydatas,
  placeholderData: [],
});
...
function EntriesTable({
  ...
  const { data } = useSuspenseQuery(getComps);

...
const companySizeEnum = pgEnum('company_size', companySizeList);
// 定义经营状况的枚举类型
export const businessStatusList = ['正常', '异常'] as const;
const businessStatusEnum = pgEnum('business_status', businessStatusList);

// 定义三大产业的枚举类型
export const industryCategoryList = ['第一产业', '第二产业', '第三产业'] as const;
const industryCategoryEnum = pgEnum('industry_category', industryCategoryList);

        ...
        <div className={cn('relative w-full cursor-pointer', inputClassName)}>
          ...
          {selectedValue && (
            <Button
              ...
              className="-translate-y-1/2 absolute top-1/2 right-7 z-10 h-5 w-5 rounded-full text-muted-foreground hover:text-foreground"
          ...
          <ChevronDownIcon
            ...
            className="-translate-y-1/2 absolute top-1/2 right-2.5 h-4 w-4 opacity-50"
          />
        </div>
      </DropdownMenuTrigger>
